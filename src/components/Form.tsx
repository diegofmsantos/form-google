        ...
        <div className="w-96 h-4/6 bg-white bg-opacity-80 rounded-lg flex flex-col justify-start items-center max-[450px]:w-[340px] max-[400px]:w-[300px]">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col justify-center items-center gap-3">
                <div className="h-16 text-center">
                    ...
                    {errors?.login?.type === 'required' && <span className="text-red-500 text-sm mb-6 max-[425px]:text-center ml-20">Digite seu login.</span>}
                    {errors?.login?.type === 'minLength' && <span className="text-red-500 text-sm mb-6 max-[425px]:text-center ml-20">Mínimo de 3 caracteres.</span>}
                </div>
                <div className="h-16 text-center">
                    <div className="flex justify-center items-center gap-2">
                    ...
                    {errors?.password?.type === 'required' && <span className="text-red-500 text-sm max-[425px]:text-center ml-20">Digite sua senha.</span>}
                    {errors?.password?.type === 'minLength' && <span className="text-red-500 text-sm max-[425px]:text-center ml-20">Mínimo de 6 caracteres.</span>}
                </div>
